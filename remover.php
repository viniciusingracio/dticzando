    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="remover.php"><i class="icon-calendar icon-white"></i> Remover</a></li>
...
<div class="container">
    ...
    <div class="col-lg-6">
            ...
            <tr>
                ...
                <td><?php echo $ler['sobrenome']; ?> </td>
                <td><?php echo $ler['email']; ?> </td>
                <td><?php echo $ler['senha']; ?> </td>
                <td><a class="btn3" href="_DeletandoUsuario.php?id=<?php echo $ler['id']; ?>&pagina=usuario" >  X  </a> </td>
