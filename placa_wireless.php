                    ...
                    <div class="col-md-12">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><a class="btn3" href="_DeletandoMaterial.php?id=<?php echo $ler['id']; ?>&pagina=placa_wireless" >  X  </a> </td>
            ...
            <div class="row">
                <div class="col-md-12">
                    <form class="form-horizontal" role="form" method="post" action=_CadastrandoMaterial.php>
                        ...
                        <input type="hidden" value="placa_wireless" name="pagina">
