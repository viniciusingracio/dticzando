                    ...
                    <div class="col-md-12">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><a class="btn3" href="_DeletandoMaterial.php?id=<?php echo $ler['id']; ?>&pagina=caixa_som" >  X  </a> </td>
                ...
                <div class="col-md-12">
                    <form class="form-horizontal" role="form" method="post" action="_CadastrandoMaterial.php">
                       ...
                       <input type="text"  placeholder="Modelo" name="modelo">
                        ...
                        <input type="hidden" value="caixa_som" name="pagina">
